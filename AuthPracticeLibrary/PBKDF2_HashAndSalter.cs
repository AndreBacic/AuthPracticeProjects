...
namespace AuthPracticeLibrary
{
    ...
    /// </summary>
    public class PBKDF2_HashAndSalter : IHashAndSalter
    {
        /// <summary>
        ...
        /// 
        /// Returns not only if the hashed password equals the hash, but also if the specified iterations needs to be upgraded to PBKDF2_HashAndSalter.Iterations
        /// </summary>
        /// <param name="password"></param>
